...
"""HRMS Addon Theme Settings (Single).

Colour overrides for the desk theme. See hrms_addon/hrms_addon/theme.py
...
from hrms_addon.hrms_addon.theme import DEFAULTS, FIELD_TO_VAR


class HRMSAddonThemeSettings(Document):
    def validate(self):
