// HRMS Addon — collapsible form sidebar.
//
...
// public/css/hrms_addon.bundle.css.

(function () {
	if (typeof frappe === "undefined") return;

	const STORAGE_KEY = "hrms_addon:form_sidebar_collapsed";
	const COLLAPSED_CLASS = "ha-form-sidebar-collapsed";
	...
	function inject() {
		...
		if (!side || !main) return;
		if (main.querySelector(".ha-sidebar-toggle")) {
			apply(stored(), main.querySelector(".ha-sidebar-toggle"));
			return;
		}

		const button = document.createElement("button");
		button.type = "button";
		button.className = "ha-sidebar-toggle";
